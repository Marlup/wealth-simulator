...
tax_calculator = TaxCalculator("taxes_by_country.json")
...
def get_contribution_inc(monthly_contribution, monthly_increment):
...
def _compute_taxes(earnings: float, n_yields: int, country: str=""):
    if country != "":
        taxes = tax_calculator.compute_taxes(earnings, n_yields=n_yields, country="spain")
        return taxes
